...
// importedCss.href = 'https://fullfaceapi.com/BibliotecaFFQueryString/css/ffsdk.css';
...
var queryStringObj = queryObj();
const username = queryStringObj.username;
const projectName = queryStringObj.projectName;
const password = "@password";
const tipo = queryStringObj.tipo;
const idadeEstimadaEGenero = queryStringObj.idadeEstimadaEGenero.toLowerCase() == 'true';
const escalaDeCinza = queryStringObj.escalaDeCinza.toLowerCase() == 'true';
const liveness = queryStringObj.liveness.toLowerCase() == 'true';
var returnRequest = "";

let validaCampoEmail = /^[a-zA-Z0-9][a-zA-Z0-9\._-]+@([a-zA-Z0-9\._-]+\.)[a-zA-Z-0-9]{2,3}/;
$("#divEtapasDoLiveness").addClass("invisivel");
$("#divGifLoading").addClass("invisivel");
var comecarDetectarRosto = false;
var condicaoParaCaptura = 0;
var arrayFotos = [];
var aparecerProgressBar = true;
var contador = 1;
var aparecerNovamenteProgressBar = 0;
var divFormCamera = document.createElement("div");
//Insetindo tags html para inserir no corpo do arquivo html
divFormCamera.innerHTML = `<div class="limiter" id="divFormCamera">
<div class="container-login100 ">
    <div class="wrap-login100 sssss">
        <div class="col-md-12" id="divCapturandoFotos">
            <div id="divCamerasDisponiveis" class="invisivel" title="Clique aqui para alterar a câmera">
                <svg xmlns="http://www.w3.org/2000/svg" onclick="abrirModalCamerasDisponiveis()" id="iconeCamera" width="25" height="25" fill="currentColor" class="bi bi-camera" viewBox="0 0 16 16">
                    <path d="M15 12a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1V6a1 1 0 0 1 1-1h1.172a3 3 0 0 0 2.12-.879l.83-.828A1 1 0 0 1 6.827 3h2.344a1 1 0 0 1 .707.293l.828.828A3 3 0 0 0 12.828 5H14a1 1 0 0 1 1 1v6zM2 4a2 2 0 0 0-2 2v6a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2h-1.172a2 2 0 0 1-1.414-.586l-.828-.828A2 2 0 0 0 9.172 2H6.828a2 2 0 0 0-1.414.586l-.828.828A2 2 0 0 1 3.172 4H2z" />
                    <path d="M8 11a2.5 2.5 0 1 1 0-5 2.5 2.5 0 0 1 0 5zm0 1a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7zM3 6.5a.5.5 0 1 1-1 0 .5.5 0 0 1 1 0z" />
                </svg>
            </div>

            <div id="divIconeAvisos" title="Clique aqui para olhar os avisos e capturar as fotos corretamente." >
                <svg xmlns="http://www.w3.org/2000/svg" data-toggle="modal" data-target="#modalAviso" tabindex="-1" width="25" height="25" fill="currentColor" id="iconeAviso" class="bi bi-exclamation-triangle" viewBox="0 0 16 16">
            ...
            <center>
                <!-- Modal CARREGANDO -->
                <div id="divGifLoading" class="invisivel">
                    <br />
                    <h2>Carregando...</h2>
                    <br>
                    <img src="image/gif/GifCarregando.gif" class="gifLoading" />
                </div>
                <div id="divCamera">
                    <br />
                    <br />
                    <div id="divEtapasDoLiveness" class="invisivel">
                        <h1 id="TextoPosicaoAleatoriaDoRosto" class="TextoPosicaoAleatoriaDoRosto"> Rotacione levemente seu rosto para
                            <font id="textoMovimentoAtual" class="posicao"></font>
                        </h1>
                    </div>
                    <br>
                    <div id="divPrincipalProgressBar">
                        <div id="myProgress" class="">
                            <div id="myBar"></div>
                        </div>
                    </div>
                    <div id="divVideoEContagem">
                        <video width="280" height="280" id="video" class="refletir-camera" autoplay playsinline></video>
                        <br /><br />
                        <p id="contagemParaZerarOsMovimentos"></p>
                    </div>
                </div>
            </center>

            <form class="login100-form validate-form formulario">
                <center>
                    <button id="btnIniciarCaptura" class="login100-form-btn btnCaptura" onclick="validarCampos()" type="button">Iniciar captura</button>
                </center>
            </form>
            <br>
            <br>
...
<form class="login100-form validate-form invisivel">
<div class="container-login100-form-btn ">
    <button class="login100-form-btn" id="btnClick">
    Avançar
</button>
</div>
</form>

<div class="modal fade bd-example-modal-sm" id="modalCarregando" tabindex="-1" role="dialog" aria-labelledby="TituloModalCentralizado" aria-hidden="true">
<div class="modal-dialog modal-dialog-centered modal-sm " role="document">
    <div class="modal-content sss">
        <div class="modal-header">
            <h5 class="modal-title text-center" id="TituloModalCentralizado">CARREGANDO...</h5>
        </div>
    </div>
</div>
</div>
...
<!-- Modal câmeras disponiveis -->
<div class="modal fade " id="modalCamerasDisponiveis" tabindex="-1" role="dialog" aria-labelledby="modalCamerasDisponiveis" aria-hidden="true">
    <div class="modal-dialog " role="document">
        <div class="modal-content ">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close" onclick="reiniciarProcesso()">
                    <span aria-hidden="true">&times;</span>
                </button>
                <h5 class="modal-title msgRetorno">Câmeras disponíveis</h5>
            </div>
            <div class="modal-body ">
                <br>
                <select id="selectCameras" class="selectCameras" onchange="selecionarCamera()"></select>
                <br>
                <br>
            </div>
            <div class="modal-footer">
                <center>
                    <button type="button" class="contBtn" data-dismiss="modal" id="btnOkSucesso" onclick="reiniciarProcesso()">FECHAR</button>
                </center>
            </div>
        </div>
    </div>
...
<div class="modal fade " id="modalAviso" tabindex="-1" role="dialog" aria-labelledby="modalAviso" aria-hidden="true">
    <div class="modal-dialog " role="document">
        <div class="modal-content ">
            <div class="modal-header modalHeader modalRetorno">
                <center>
                    <h5 class="modal-title tituloModalAviso" id="">Avisos!</h5>
                </center>
            </div>
            <div class="modal-body ">

                <p class="msgRetorno text-center">Fique atento aos avisos abaixo para um correto funcionamento.</p>
                <br>
                <center>
                    <img src="image/avisosPortugues.webp" class="imgAviso" alt="" class="icones">
                </center>
            </div>

            <div class="modal-footer">
                <center>
                    <button type="button" class="contBtn" id="btnOkSucesso" data-dismiss="modal">OK</button>
                </center>
            </div>
        </div>
    </div>
...
<!-- Modal erro -->
<div class="modal fade " id="modalErro" tabindex="-1" role="dialog" aria-labelledby="modalSucesso" aria-hidden="true">
    <div class="modal-dialog " role="document">
        <div class="modal-content ">
            <div class="modal-header modalHeaderErro modalRetorno">
                <br>
                <center>
                    <img src="image/triste.webp" alt="" class="icones">
                    <br>
                    <h5 class="modal-title tituloModal" id="">Erro!</h5>
                </center>
            </div>
            <div class="modal-body ">

                <p class="msgRetorno mensagemRetornoErro text-center"></p>
                <br>
            </div>
            ...
            <div class="modal-footer">
                <center>
                    <button type="button" class="contBtn" id="btnOkErro" data-dismiss="modal">OK</button>
                </center>
            </div>
        </div>
    </div>
...
<div class="modal fade " id="modalSucesso" tabindex="-1" role="dialog" aria-labelledby="modalSucesso" aria-hidden="true">
    <div class="modal-dialog " role="document">
        <div class="modal-content ">
            <div class="modal-header modalHeaderSucesso modalRetorno">
                <br>
                <center>
                    <img src="image/Feliz.webp" alt="" class="icones">
                    <br>
                    <h5 class="modal-title tituloModal" id="">Sucesso!</h5>
                </center>
            </div>
            <div class="modal-body ">

                <p class="msgRetorno mensagemRetornoSucesso text-center"></p>
                <br>
                <div id="idadeEstimadaEGeneroUsuario">
                    <p class="message text-center msgGenero msgRetorno">Idade estimada <strong>(</strong>+- 5 anos<strong>) </strong> : <span class="font-weight-bold" id="idadeEstimadaUsuario"> </span></p>
                    <p class="message text-center msgAnoNascimento msgRetorno">Gênero : <span class="font-weight-bold" id="generoUsuario"> </span></p>
                </div>
            </div>
...
<div class="modal fade " id="modalAtencao" tabindex="-1" role="dialog" aria-labelledby="modalAtencao" aria-hidden="true">
    <div class="modal-dialog " role="document">
        <div class="modal-content ">
            <div class="modal-header modalHeaderAtencao modalRetorno">
                <br>
                <center>
                    <img src="image/atencao.webp" alt="" class="icones">
                    <br>
                    <h5 class="modal-title tituloModal" id="">Atenção!</h5>
                </center>
            </div>
            <div class="modal-body ">

                <p class="msgRetorno text-center mensagemRetornoAtencao"></p>
                <br>
            </div>

            <div class="modal-footer">
                <center>
                    <button type="button" class="contBtn" id="btnOkAtencao" data-dismiss="modal">OK</button>
                </center>
            </div>
        </div>
    </div>
...
//Inserindo no corpo do arquivo html
document.body.appendChild(divFormCamera);

//Validando se é cadastro ou autenticação, se for cadastro, o input nome aparece, se for autenticação, o input nome não aparece
if (tipo == "cad") {
    $('#divInputNome').removeClass("invisivel");
} else {
    $('#divInputNome').addClass("invisivel");
}


//Inserir as imagens capturadas na variavel divImagens
var divImagens = document.getElementById("divImagens");

//Tirar fotos com liveness, sem intervalo de tempo, essa função vai ser executada se a ativação do liveness na ponta estiver ativada
function tirarFotoComLiveness() {
    tirarFoto();
}

//Tirar fotos sem liveness, incluindo um intervalo de tempo e não necessitando de movimentos unicos, essa função vai ser executada se a ativação do liveness na ponta estiver desativada
function tirarFotosSemLiveness() {
    $("#divCamerasDisponiveis").addClass("invisivel");
    $("#divIconeAvisos").addClass("invisivel");
    $("#btnIniciarCaptura").addClass("invisivel");
    var intervaloDeTempo = setInterval(function () {
        if (contador < 6) {
            tirarFoto();
        } else {
...
//Criando canvas, deixando em escala de cinza e incluindo borda na câmera
function tirarFoto() {
    returnRequest = "";
    //Criando um ID e um NAME para cada CANVAS
    var canvas = document.createElement("canvas");
    canvas.setAttribute('class', 'estiloCanvas refletir-Camera invisivel');

    mostraImagem(canvas);

    //Deixando as imagens em escala de cinza
    if (escalaDeCinza == true) {

        var pl = null;
        pl = new SimpleImage(canvas);
        for (var pixel of pl.values()) {
    ...
    arrayFotos.push(canvas.toDataURL("image/jpeg").replace("data:image/png;base64,", "").replace("data:image/jpeg;base64,", ""));
    divImagens.appendChild(canvas);

    if (contador == 1) {
        $("#video").addClass("borderLeft");
    } else if (contador == 2) {
        $("#video").addClass("borderTop");
    } else if (contador == 3) {
        $("#video").addClass("borderRight");
    } else if (contador == 4) {
        $("#video").addClass("borderBottom");
    }
    contador++;
}

// Removendo fotos e zerando o arrayFotos
function removerFotos() {
    while (divImagens.firstChild) {
        divImagens.removeChild(divImagens.firstChild);
    }
    arrayFotos = [];
}

//Mostrar imagems capturadas
...
//Retornando as fotos em formato de json para enviar para a controller
function RetornaJsonFotos() {
    var jsonFotos = JSON.stringify(arrayFotos);
    return jsonFotos;
}

//Chamar função tirarFotoComLiveness();
function iniciarCapturaComLiveness() {
    contagemParaZerarMovimentos = 0;
    // contagemParaZerarMovimentos = 60;
    $('#modalCarregando').modal({
        backdrop: 'static',
        keyboard: false
    });
    comecarDetectarRosto = true;
    var i = 0;
...
//Chama a função tirarFotosSemLiveness();
function iniciarCapturaSemLiveness() {
    $("#email").prop('disabled', true);
    $("#nome").prop('disabled', true);
    $("#btnIniciarCaptura").addClass("invisivel");
    tirarFotosSemLiveness();
}

//Gerar token
function gerarToken() {
    $.ajax({
        url: "https://fullfaceapi.com/fffacerecognition/tokapi/token",
        contentType: "application/x-www-formurlencoded",
        data: `grant_type=password&username=${username}&password=${password}&scope=${projectName}`,
        type: "POST",
        success: function (response) {
            enviarDados(response.access_token);
        },
        error: function (response, ret) {
            $(".mensagemRetornoErro").text("Oops, ocorreu um erro inesperado, por favor entre em contato com nosso suporte técnico.");
            $("#modalErro").modal("show");

            if (response.status == 0 || response.status == null || response.status == "") {
                returnRequest = {
                    "token": "Oops, ocorreu um erro inesperado, por favor entre em contato com nosso suporte técnico."
                }
            } else {
                returnRequest = {
                    "token": response.responseJSON.error_description,
                    "status": response.status
                }
            }
            $("#divCamerasDisponiveis").removeClass("invisivel");
            onFinishFullFace(returnRequest);
            retornoApiReiniciarProcesso();
        }
    });
}

//Logo após enviar para a api, reiniciar o processo zerando.
function retornoApiReiniciarProcesso() {
    if (liveness == true) {
        condicaoParaGerarMovimentosRandomicos = true;
        $("#divEtapasDoLiveness").addClass("invisivel");
        $("#contagemParaZerarOsMovimentos").addClass("invisivel");
    }

    contador = 1;
    $("#divGifLoading").addClass("invisivel");
    $("#divCamera").removeClass("invisivel");
    $(".formulario").removeClass("invisivel");
    $("#btnIniciarCaptura").removeClass("invisivel");
    ...
    $("#divIconeAvisos").removeClass("invisivel");
...
function iniciarCaptura() {
    if (liveness == true) {
        iniciarCapturaComLiveness();
    } else if (liveness == false) {
        iniciarCapturaSemLiveness();
    }
}


//Enviar dados para API
function enviarDados(token) {
    var url = "";
    if (tipo == "cad") {
        url = "https://fullfaceapi.com/fffacerecognition/cadapi/users/register";

    } else if (tipo == "aut") {
        url = "https://fullfaceapi.com/fffacerecognition/autapi/users/authenticate";
    }
    ...
    if (tipo == "cad") {
        json = {
            ...
            accessToken: token,
            //Email usuario
            keys: JSON.parse(queryStringObj.keys),
            //Nome Projeto
    ...
    $.ajax({
        ...
        data: json,
        type: "POST",
        success: function (response, data, ret) {
            $("#divCamerasDisponiveis").removeClass("invisivel");
            var nomeUsuario = "";
            var array = response.keys;
            for (var i = 0; i < array.length; i++) {
                if (array[i].key == "nome") {
                    nomeUsuario = array[i].value;
                }
            }

            //Cadastro
            if (tipo == "cad") {
                $("#idadeEstimadaEGeneroUsuario").addClass("invisivel");
                $(".mensagemRetornoSucesso").text(`Olá ${nomeUsuario}, você foi cadastrado com sucesso.`);

                returnRequest = {
                    "registration": "Usuário cadastrado com sucesso.",
                    "status": ret.status
                }
            }
            //Autenticação
                ...
                returnRequest = {
                    "authentication": "Usuário autenticado com sucesso.",
                    "status": ret.status
                }

                if (idadeEstimadaEGenero == true) {
                    var today = new Date();
                    var ano = today.getFullYear();
                    var idadeUsuario = ano - response.birthYear;
                    var generoUsuario = "";

                    $("#idadeEstimadaUsuario").text(`${idadeUsuario} anos`);
                    ...
                    $("#generoUsuario").text(generoUsuario);

                    $("#idadeEstimadaEGeneroUsuario").removeClass("invisivel");
                } else {
                    $("#idadeEstimadaEGeneroUsuario").addClass("invisivel");
                }

                $(".mensagemRetornoSucesso").text(`Olá ${nomeUsuario}, que bom ter você com a gente.`);
            }
        ...
        error: function (response) {
            $("#divCamerasDisponiveis").removeClass("invisivel");
            const codigoRetorno = response.status;

            //IdenticalImages - cad/aut
            if (codigoRetorno == 448) {
                $(".mensagemRetornoAtencao").text("Precisamos que você movimente levemente seu rosto.");

                $('#modalAtencao').modal({ backdrop: 'static', keyboard: false });
                mostrarModalAvisos();
                retornoApiReiniciarProcesso();
            }
            //NotEnoughPictures - cad/aut
            else if (codigoRetorno == 455) {
                $(".mensagemRetornoAtencao").text("Estamos quase lá, só vamos precisar de mais algumas imagens sua.");

                $('#modalAtencao').modal({ backdrop: 'static', keyboard: false });
                mostrarModalAvisos();
                retornoApiReiniciarProcesso();
            }
            //InvalidToken - cad/aut
            else if (codigoRetorno == 457) {
                $(".mensagemRetornoErro").text("Oops este código não é valido. Verifique e tente novamente ou entre com contato.");
                $("#modalErro").modal("show");
                retornoApiReiniciarProcesso();
            }
            //CouldNotGenerateTemplates - cad/aut
            else if (codigoRetorno == 458) {
                $(".mensagemRetornoAtencao").text("Estamos quase lá, só vamos precisar de mais algumas imagens sua.");
            ...
            //FaceAlreadyRegistered - cad
            else if (codigoRetorno == 461) {
                $(".mensagemRetornoAtencao").text("Olá sua face já está cadastrada, agora é só se autenticar.");

                $('#modalAtencao').modal({ backdrop: 'static', keyboard: false });
                mostrarModalAvisos();
                retornoApiReiniciarProcesso();
            }
            //NotAuthenticatedFace - aut
            else if (codigoRetorno == 462) {
                $(".mensagemRetornoAtencao").text("Oops, não encontramos seu cadastro, deseja cadastrar ? Caso já esteja cadastrado, tente novamente.");
            ...
            //UserNotFound - aut
            else if (codigoRetorno == 466) {
                $(".mensagemRetornoErro").text("Oops, Não encontramos seu email.");
                $("#modalErro").modal("show");
                retornoApiReiniciarProcesso();
            }
            //SearchOneToManyNotAllowed - aut
            else if (codigoRetorno == 467) {
                $(".mensagemRetornoErro").text("Oops, ocorreu um erro na busca do seu cadastro, por favor entre contato com o time técnico.");
                $("#modalErro").modal("show");
                retornoApiReiniciarProcesso();
            }
            //FailedLiveness - cad/aut
            else if (codigoRetorno == 468) {
                $(".mensagemRetornoAtencao").text("Oops, Você não passou na prova de vida, Tente Novamente.");

                $('#modalAtencao').modal({ backdrop: 'static', keyboard: false });
                mostrarModalAvisos();
                retornoApiReiniciarProcesso();
            }
            //InvalidBase64 - cad/aut
            else if (codigoRetorno == 475) {
                $(".mensagemRetornoAtencao").text("Estamos quase lá, só vamos precisar de mais algumas imagens sua.");
            ...
            //KeysAlreadyInUse - cad
            else if (codigoRetorno == 480) {
                $(".mensagemRetornoErro").text("Os dados informados já estão cadastrado para outro usuário.");
                $("#modalErro").modal("show");
                retornoApiReiniciarProcesso();
            }
            // 400 : Bad Request  // 460 : ProjectDoesNotExist // 463 : NullOrEmptyKeys // 477 : NullOrEmptyAttributes // 478 : DuplicatedAttributes // 479 : DuplicatedKeyValue // 500 : Internal Server Error // todos cad/aut
            else if (codigoRetorno == 400 || codigoRetorno == 460 || codigoRetorno == 463 || codigoRetorno == 477 || codigoRetorno == 478 || codigoRetorno == 479 || codigoRetorno == 500) {
                $(".mensagemRetornoErro").text("Oops, ocorreu um erro inesperado, por favor entre em contato com nosso suporte técnico.");
                $("#modalErro").modal("show");
                retornoApiReiniciarProcesso();
            }
            ...
            if (tipo == "cad") {
                returnRequest = {
                    "registrationError": response.responseJSON.message,
                    "status": response.status
                }
            } else if (tipo == "aut") {
                returnRequest = {
                    "authenticationError": response.responseJSON.message,
                    "status": response.status
                }
            }
            onFinishFullFace(returnRequest);
...
//Mostrar modal de avisos quando o usuario clicar no botão da modal de atenção.
function mostrarModalAvisos() {
    document.getElementById("btnOkAtencao").addEventListener("click", function () {
        $("#modalAviso").modal("show");
    });
}

//Fazer listagem
function listagem(token, projectName) {
    var jsonListagem = {
        //Token
        accessToken: token,
        //Email usuario
    ...
    // //Enviar para API
    $.ajax({
        url: "urlAhttps://fullfaceapi.com/fffacerecognition/lstapi/users/listpi",
        contentType: "application/x-www-formurlencoded",
        data: jsonListagem,
        type: "POST",
        success: function (response, data) {
            enviarDados(response.access_token, projectName);
        },
...
// //Importando a biblioteca faceapi para detectar rosto
// var importedFaceApi = document.createElement('script');
// // importedFaceApi.src = 'https://fullfaceapi.com/BibliotecaFFQueryString/scripts/faceapi/face-api.min.js';
// importedFaceApi.src = 'https://fullfaceapi.com/BibliotecaFF/scripts/faceapi/face-api.min.js';
// //importedFaceApi.src = 'https://fullfaceapi.com/faceapi/face-api.min.js';
// document.head.appendChild(importedFaceApi);

// //Importando o arquivo posicaoTempo para controlar o tempo de captura das fotos
// var importedPosicaoTempo = document.createElement('script');
// importedPosicaoTempo.src = 'https://fullfaceapi.com/BibliotecaFFQueryString/scripts/faceapi/posicaoTempo.js';
// document.head.appendChild(importedPosicaoTempo);

// //Importando arquivo greyScale para deixar as imagens capturadas em escala de cinza (preto e branco);
// var importedGreyScale = document.createElement('script');
// importedGreyScale.src = 'https://fullfaceapi.com/BibliotecaFFQueryString/scripts/greyScale/greyScale.js';
// document.head.appendChild(importedGreyScale);

// //Importando arquivo detectandoCameras para detectar cameras disponiveis
// var importedDetectandoCamerasDisponiveis = document.createElement('script');
// importedDetectandoCamerasDisponiveis.src = 'https://fullfaceapi.com/BibliotecaFFQueryString/scripts/camera/detectandoCameras.js';
// document.head.appendChild(importedDetectandoCamerasDisponiveis);

// //Importando arquivo bootstrap
// var importedBootstrap = document.createElement('script');
// importedBootstrap.src = 'https://fullfaceapi.com/BibliotecaFFQueryString/bootstrap/js/bootstrap.min.js';
// document.head.appendChild(importedBootstrap);

// //Importando arquivo bootstrap
// var importedMain = document.createElement('script');
// importedMain.src = 'https://fullfaceapi.com/BibliotecaFFQueryString/scripts/main/main.js';
// document.head.appendChild(importedMain);

// //Importando arquivo detectandoMovimentos para detectar os movimentos de cada posicao solicitada
// var importedDetectandoMovimentos = document.createElement('script');
// importedDetectandoMovimentos.src = 'https://fullfaceapi.com/BibliotecaFFQueryString/scripts/faceapi/detectandoMovimentos.js';
// document.head.appendChild(importedDetectandoMovimentos);